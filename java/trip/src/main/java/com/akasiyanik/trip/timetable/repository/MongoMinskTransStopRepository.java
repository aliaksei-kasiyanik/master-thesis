 ...
 */
@Repository
public class MongoMinskTransStopRepository {

    private static final String collectionName = "minskTransStops";
    ...
    public MinskTransStop getStopByMinorIdAndName(Long id, String name) {
        Query query = new Query();
